...
import { BuyerFront } from "../BuyerFront";
...
const Categories = () => {
  return (
    <Router>
      ...
      <Switch>
        <Route path="/" exact component={BuyerFront} />
        <Route path="/business" exact component={Business} />
        <Route
          path="/design_and_creative"
          exact
          component={DesignAndCreative}
        />
        <Route path="/digital_marketing" exact component={DigitalMarketing} />
        <Route
          path="/engineering_and_architect"
          exact
          component={EngineeringAndArchitect}
        />
        ...
        <Route
          path="/writting_and_translation"
          exact
          component={WrittingAndTranslation}
        />
      </Switch>
    </Router>
  );
